	...
	render() {
		return (
			<div className='w3-container w3-card-4 w3-light-grey'>
				...
				<input className='w3-input' type="text" name="name" value={this.state.name} onChange={this.handleChange}
					 onKeyPress={this.handleKeyPress} ref={(ref)=>{this.nameInput = ref;}}/>
				<label className='w3-label w3-text-dark-grey'>Phone</label>
				<input className='w3-input' type="text" name="phone" value={this.state.phone}
